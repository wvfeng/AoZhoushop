            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td class="color"><?php echo ((isset($v["yname"]) && ($v["yname"] !== ""))?($v["yname"]):"-"); ?></td>
                            <td class="color"><?php echo ((isset($v["ymoney"]) && ($v["ymoney"] !== ""))?($v["ymoney"]):"-"); ?></td>
                            <td class="color"><?php echo ((isset($v["ynum"]) && ($v["ynum"] !== ""))?($v["ynum"]):"-"); ?></td>
                            <td class="color"><?php echo ((isset($v["ystart_date"]) && ($v["ystart_date"] !== ""))?($v["ystart_date"]):"-"); ?></td>
                            <td class="color"><?php echo ((isset($v["yend_date"]) && ($v["yend_date"] !== ""))?($v["yend_date"]):"-"); ?></td>
                            <td>
