...
<div class="pop-up-bj pop-up-delete none">
                ...
                <div class="info-right" style="width: 700px;">
                    ...
                    <div class="info-model clearfix">
                        ...
                        <div style="height:80px;">
                            ...
                            <img src="/mallplatform/Public/shopimg/<?php echo ($res["img"]); ?>"style="width:80px;height:80px;" id="browse">
                        </div>
                    </div>
                    <div class="info-model clearfix">
                        <span>商品滚动图<br/>690*410</span>
                        <div style="height:80px;" class="slp">
                            <?php if(is_array($res["sliedimg"])): $i = 0; $__LIST__ = $res["sliedimg"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><img style='width:80px;height:80px;'src='/mallplatform/Public/shopimg/<?php echo ($v); ?>'>
                                <input type='hidden' name='slide[]' value='<?php echo ($v); ?>'>
                                <b class="sremove">删除</b><?php endforeach; endif; else: echo "" ;endif; ?>
                            <img src="/mallplatform/Public/Admin/images/up.jpg"style="width:80px;height:80px;" id="browse_slid">
                        </div>
                    </div>
                    <div class="info-model clearfix">
                        <span>商品简介</span>
                        <div style="height:auto;"><textarea placeholder="简介" name="introduce"><?php echo ($res["introduce"]); ?></textarea></div>
                    </div>
                    <div class="info-model clearfix">
                        <span>商品详情</span>
                    ...
                    <div class="info-model clearfix">
                        <span>所需积分</span>
                        <div><input type="number" name="integral" value="<?php echo ($res["integral"]); ?>" placeholder="积分"/></div>
                    </div>
                    <div class="info-model clearfix">
                        <span>所需现金</span>
    ...
    var uploader = new plupload.Uploader({
        ...
        flash_swf_url : '/mallplatform/Public/admin/js/plupload/Moxie.swf', //swf文件，当需要使用swf方式进行上传时需要配置该参数
        silverlight_xap_url : '/mallplatform/Public/admin/js/plupload/Moxie.xap' //silverlight文件，当需要使用silverlight方式进行上传时需要配置该参数
    });    
    ...
    uploader.bind('FileUploaded',function(uploader,files,responseObject){
      $('#browse').attr("src","/mallplatform/Public/shopimg/"+responseObject.response+"");
    ...
    uploader_slid.bind('FileUploaded',function(uploader_slid,files,responseObject){
      $('#browse_slid').before("<img style='width:80px;height:80px;'src='/mallplatform/Public/shopimg/"+responseObject.response+"'>");  
    ...
    <script type='text/javascript' src='/mallplatform/Public/ueditor/ueditor.config.js'></script>
    <script type='text/javascript' src='/mallplatform/Public/ueditor/ueditor.all.min.js'></script>
