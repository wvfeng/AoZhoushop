            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td class="color"><?php echo ((isset($v["wname"]) && ($v["wname"] !== ""))?($v["wname"]):"-"); ?></td>
 
                            <td class="color"><?php echo ((isset($v["wiphone"]) && ($v["wiphone"] !== ""))?($v["wiphone"]):"-"); ?></td>
                            <td class="color"><?php echo ((isset($v["wsort"]) && ($v["wsort"] !== ""))?($v["wsort"]):"-"); ?></td>
                            <td>
                                <?php if($v['wtype'] == 1): ?><a href="<?php echo U('doupdown',['wtype'=>0,'id'=>$v['id']]);?>">正常</a>
                                <?php else: ?>
                                    <a href="<?php echo U('doupdown',['wtype'=>1,'id'=>$v['id']]);?>" style="color:#999;">关闭</a><?php endif; ?>
                            </td>
                            <td>
