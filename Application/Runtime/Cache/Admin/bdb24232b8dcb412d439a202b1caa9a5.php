...
<div class="logo" style="text-align:left;">
	<a href="javascrit:;" style="color:#fff;font-weight: 600;font-size:24px;">
		<!-- <img src="/mallplatform/Public/Admin/images/logo.png" style="height:59px;padding-top:2px;"/>  -->
        <span style="display:inline-block;padding:12px 0 0 21px;">会员系统</span>
    </a>
</div>
<span style="float:left;height:50px;font-weight:bold;font-size:22px;line-height:50px;margin-left:24px;">会员系统后台</span>
<div class="personalInformation" >
	...
	<div class="headimg" style="display:none;">
		<a href="javascrit:;">
			<img src="/mallplatform/Public/Admin/images/headimg.jpg"/>
		</a>
	</div>
