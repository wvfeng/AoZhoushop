                ...
                <div class="info-right" style="width: 700px;">
                    ...
                    <div class="info-model clearfix">
                        ...
                        <div style="height:80px;width:80px;">
                            ...
                            <img src="/mallplatform/Public/Admin/images/up.jpg" style="width:80px;height:80px;cursor: pointer;" id="browse">
                        </div>
                    </div>
                    <div class="info-model clearfix">
                        <span>商品滚动图<br/>(690*410)</span>
                        <div style="height:80px;" class="slp">
                            <img src="/mallplatform/Public/Admin/images/up.jpg"style="width:80px;height:80px;cursor: pointer;" id="browse_slid">
                        </div>
