                    ...
                    <div class="info-model clearfix">
                        ...
                        <div>
                            <select name="uid" class="is_vip" style="color: #666;width:199px;font-size: 14px;border:1px solid #eef1f1;border-radius:3px;height: 36px;margin-right: 5px;">
                                    ...
                                    <?php if(is_array($one)): $i = 0; $__LIST__ = $one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="info-model clearfix">
                        <span>分类名称</span>
                        <div><input type="text" name="classname" value="" placeholder="分类名称"/></div>
                    </div>
                    <div class="info-model clearfix">
