...
<div class="pop-up-bj pop-up-delete none">
    ...
    <div class="info-main main FromUpToDown">
        <h1>自提点编辑 <a href="javascript:history.go(-1);"style="float:right;">返回上一级</a></h1>
            ...
            <div class="info-list clearfix">
                <div class="info-right" style="width: 700px;">
                    <div class="info-model clearfix">
                        <span>自提名称</span>
                        <div><input type="text" name="zname" value="<?php echo ($res["zname"]); ?>" placeholder="自提名称"/></div>
                    </div>
                    <div class="info-model clearfix">
                        <span>地址</span>
                        <div><input type="text" name="zaddress" value="<?php echo ($res["zaddress"]); ?>" placeholder="地址"/></div>
                    </div>
                    <div class="info-model clearfix">
                        <span>联系人</span>
                        <div><input type="text" name="zman" value="<?php echo ($res["zman"]); ?>" placeholder="联系人"/></div>
                    </div>
                    <div class="info-model clearfix">
                        <span>联系电话</span>
                        <div><input type="text" name="ziphone" value="<?php echo ($res["ziphone"]); ?>" placeholder="联系电话"/></div>
                    </div>
